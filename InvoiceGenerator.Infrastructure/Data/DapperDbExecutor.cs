...
namespace InvoiceGenerator.Infrastructure.Data
{
    public class DapperDbExecutor : IDbExecutor
    {
        ...
        public async Task<IEnumerable<TReturn>> QueryAsync<TFirst, TSecond, TReturn>(string sql, Func<TFirst, TSecond, TReturn> map, string splitOn, object? param = null, CommandType? commandType = null)
        {
            using var connection = new SqlConnection(_connectionsString);
            await connection.OpenAsync();
